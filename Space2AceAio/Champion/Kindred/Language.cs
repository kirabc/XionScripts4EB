...
using Space2Ace_Kindred.Spell_Database;

namespace Space2Ace_Kindred
{
    internal class Language
    {
        ...
        public static void EnglishMenu()
        {
            ...
            comboMenu.Add("r.Lifesaveer", new CheckBox("Use (R)"));
            ...
            miscMenu.Add("protector", new CheckBox("Disable Protector(Prevent wasteing the Ultimate)?"));
            foreach (var enemy in ObjectManager.Get<AIHeroClient>().Where(o => o.IsEnemy))
            {
