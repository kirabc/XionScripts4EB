    ...
    public static class Drawings
    {
        ...
        private static void Drawing_OnDraw(EventArgs args)
        {
            if (ConfigMenu.SelectedPrediction == 0 && ConfigMenu.EnableDrawings)
            {
                ...
                Drawing.DrawText(ConfigMenu.HitChanceDrawingX, ConfigMenu.HitChanceDrawingY -10, Color.Red,
                    string.Format("Space2AcePrediction Only!!", s_CastCount));
                Drawing.DrawText(ConfigMenu.HitChanceDrawingX, ConfigMenu.HitChanceDrawingY + 10, Color.Red,
                    string.Format("Casted Spell Count: {0}", s_CastCount));
                Drawing.DrawText(ConfigMenu.HitChanceDrawingX, ConfigMenu.HitChanceDrawingY + 30, Color.Red,
                    string.Format("Hit Spell Count: {0}", s_HitCount));
                Drawing.DrawText(ConfigMenu.HitChanceDrawingX, ConfigMenu.HitChanceDrawingY + 50, Color.Red,
