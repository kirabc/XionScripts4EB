...
namespace SebbyLib
{
    internal class Program
    {
        ...
        public static void GameOnOnGameLoad()
        {
            ...
            Config = MainMenu.AddMenu("Space2Ace AIO", "Space2Ace AIO" + ObjectManager.Player.ChampionName);
            ...
            Config.Add("AIOmode", new Slider("AIO mode (0 : Util & Champ | 1 : Only Champ | 2 : Only Util)", 1, 0, 2));
            AIOmode = getSliderItem("AIOmode");

            Config.Add("PredictionMODE", new Slider("Prediction MODE (0 : EB Pred | 1 : OKTW© PREDICTION | 2 : Space2AcePrediction | 3 : SDK)", 0, 0, 3));
            ...
            {
                Space2AcePrediction.Prediction.Initialize(Config);
            ...
            if (AIOmode != 2)
            {
                ...
                {
                    case "Anivia":
                 //       Space2Ace.Champion.Anivia.Program.LoadOKTW();
                        break;
                    case "Annie":
         ...
         //               PortAIO.Champion.Ekko.Program.LoadOKTW();
                 ...
                 //       OneKeyToWin_AIO_Sebby.Champions.Jayce.LoadOKTW();
                        break;
                    case "Jinx":
                        Space2Ace_Jinx.Jinx.LoadOKTW();
                        Chat.Print("Space2Ace - Champion Jinx Loaded!");
                        break;
                    case "Karthus":
                        //Karthus.LoadOKTW();
                        break;
