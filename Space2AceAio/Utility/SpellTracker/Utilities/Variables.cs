...
namespace SpellTracker
{
    ...
    class Variables
    {
        ...
        /// The Menu name.
        /// </summary>        
        public static string MainMenuName = "SpellTracker";

        /// <summary>
        /// The Menu Codename.
        /// </summary>
        public static string MainMenuCodeName = "SpellTracker";
        ...
        internal static int ExpXAdjustment(AIHeroClient unit)
        {
            throw new NotImplementedException();
        }

        internal static int ExpYAdjustment(AIHeroClient unit)
        {
            throw new NotImplementedException();
        }
        ...
        public static int ExpX { get; internal set; }
        public static int ExpY { get; internal set; }
    }
}