...
namespace Space2Ace_Prediction
{
    public class Prediction
    {
        ...
        public static void Initialize()
        {
            ...
            Config = MainMenu.AddMenu("Space2Ace Prdiction", "sdkpaksldjaskdjlkasjdk");
            Config.Add("ENABLED", new CheckBox("Enabled"));
            Config.Add("SPREDHITC", new ComboBox("HitChance", 1, "Skillshoot Champs", "Most Champs", "Special Zed"));
            Config.AddSeparator();
