...
namespace Space2Ace.Utility
{
    class Loader
    {
        
        public static bool Autoskiller { get { return Miscc["Autoskiller"].Cast<CheckBox>().CurrentValue; } }
        ...
        public static bool Prediction { get { return Miscc["Prediction"].Cast<CheckBox>().CurrentValue; } }
        ...
        {
            Miscc = MainMenu.AddMenu("Space2Ace Misc", "Xionmisc");
            ...
            if (Champion.Contains(ObjectManager.Player.ChampionName))
            {
                ...
                {
                    Miscc.Add("soraka", new ComboBox("Use addon for Soraka : ", 0, "Space2Ace - Soraka"));
                }
                ...
                {
                    Miscc.Add("lucian", new ComboBox("Use addon for Lucian : ", 0, "Space2Ace - Lucian"));
                }
                ...
                {
                    Miscc.Add("vayne", new ComboBox("Use addon for Vayne : ", 0, "Space2Ace - Vayne"));
                }
                ...
                {
                    Miscc.Add("katarina", new ComboBox("Use addon for Katarina : ", 0, "Space2Ace - Katarina"));
                }
                ...
                {
                    Miscc.Add("draven", new ComboBox("Use addon for Draven : ", 0, "Space2Ace Draven"));
                }
                ...
                {
                    Miscc.Add("kindred", new ComboBox("Use addon for Kindred : ", 0, "Space2Ace - Kindred"));
                }
                if (Player.ChampionName.Equals(Champion[25]))
                {
                    Miscc.Add("lux", new ComboBox("Use addon for Lux : ", 0, "Space2Ace - Lux"));
                }
                ...
                {
                    Miscc.Add("ryze", new ComboBox("Use addon for Ryze : ", 0, "Space2Ace - Ryze"));
                }
                ...
                {
                    Miscc.Add("zed", new ComboBox("Use addon for Zed : ", 0, "Space2Ace - Zed"));
                }
            ...
            Miscc.AddSeparator();
            Miscc.Add("activator", new CheckBox("Enable Xionivator?", true));
            Miscc.Add("tracker", new CheckBox("Enable SpellTracker?", true));
            Miscc.Add("recall", new CheckBox("Enable Recall Tracker?", true));
            Miscc.AddSeparator();
            Miscc.Add("skin", new CheckBox("Enable Skin Hack?", false));
            Miscc.Add("godTracker", new CheckBox("Enable God Jungle Tracker?", true));
            Miscc.AddSeparator();
            Miscc.Add("ping", new CheckBox("Enable Ping Block?", false));
            Miscc.Add("evade", new CheckBox("Enable XionVade?", true));
            Miscc.Add("human", new CheckBox("Enable Humanizer?", false));
            Miscc.Add("gank", new CheckBox("Enable GankAlerter?", true));
            Miscc.AddSeparator();
            ...
            Miscc.Add("Prediction", new CheckBox("Enable Space2Ace Prediction?", true));
            Miscc.Add("Autoskiller", new CheckBox("Enable Space2Ace Autoskiller?", true));
