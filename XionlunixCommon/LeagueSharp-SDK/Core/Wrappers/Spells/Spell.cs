...
namespace LeagueSharp.SDK
{
    ...
    public class Spell
    {
        ...
        ///     The <see cref="AIHeroClient" /> target.
        /// </returns>
        public AIHeroClient GetTarget(float extraRange = 0, bool accountForCollision = false, IEnumerable<AIHeroClient> champsToIgnore = null)
        {
            return TargetSelector.GetTarget(this.Range + extraRange, this.DamageType);
        }
